...
| `docs/models/` | Model candidate roster (RRL-grounded), model-lifecycle guidance (see `models/README.md`), and `TEAMMATE-GUIDE.md` (trusted path for new agents/humans). |
