...
**Date:** 2026-07-17
**Status:** Draft
**Purpose:** Define how the three Odin modules (PFP, Forecaster, Anomaly Detector) integrate

---

## 1. Overview

This document specifies the integration architecture for the three Odin modules:

1. **PFP Classifier** — Financial Behavior Profiling
...
|--------|-------|--------|---------|
| PFP Classifier | Transaction history (3 months) | PFP class + confidence | On classification request |
| Forecaster | Transaction history (6 months) | Predicted next month expenses | On forecast request |
...
```json
{
  ...
  "classification": {
    ...
    "confidence": 0.87,
    "income_stability_cv": 0.12,
    "obligation_ratio": 0.72,
    "tier_used": 2,
...
```
POST /api/v1/analyze          # Run all three modules
